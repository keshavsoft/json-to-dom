...
export const compileNode = ({ inNode, inContext = {}, inRootData = {} } = {}) => {
    ...
    if (isIteration) {
        ...
        const rawCollection = localContext[sourceKey]
    ...
    if (cloned.attributes) {
        ...
        // Bind data value if matching field name exists
        const fieldName = currentItem.field || currentItem.columnName || currentItem.name;
        if (fieldName && localRootData[fieldName] !== undefined && localRootData[fieldName] !== null) {
