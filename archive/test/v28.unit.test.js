...
import buildSpecElement, {
    ...
    meta,
    tree
} from "../src/v28/index.js";

import extractFormValues from "../src/v28/chapters/chapter3_activation/listeners/v2/extractFormValues.js";
import resetForm from "../src/v28/chapters/chapter3_activation/listeners/v2/resetForm.js";
...
describe("json-to-dom v28 3-Chapter Story Architecture", () => {
    test("1. Meta information", () => {
        assert.equal(meta.version, "v28.0");
