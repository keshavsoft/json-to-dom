...
import buildSpecElement, {
    ...
    bindActions,
    meta
} from "../src/v30/index.js";
import listeners from "../src/v30/chapters/chapter3_activation/listeners/index.js";
import data from "../src/v30/chapters/chapter1_inspection/standards/index.js";

import extractFormValues from "../src/v30/chapters/chapter3_activation/listeners/v2/extractFormValues.js";
import resetForm from "../src/v30/chapters/chapter3_activation/listeners/v2/resetForm.js";
...
describe("json-to-dom v30 3-Chapter Story Architecture", () => {
    test("1. Meta information & Standards Schema", () => {
        assert.equal(meta.version, "v30.0");
