...
const buildSpecElement = (inArgs) => {
    ...
    if (localValidate && localSpec) {
        ...
        if (!validationResult.isValid) {
            console.warn("[json-to-dom v23: validation error]", validationResult.errors, validationResult);
        } else if (validationResult.warnings && validationResult.warnings.length > 0 && localShowLog) {
            console.warn("[json-to-dom v23: validation warning]", validationResult.warnings);
        }
    }
