...
/**
 * domElementBuilder - Pure HTML Element Builder (v20)
 * Builds a native DOM element purely from HTML definitions (stages 0 to 5):
 * 0. Create Element
 ...
 * 5. Append Children
 */
const domElementBuilder = ({ inSpec, inTagDef, inClassList, inShowLog = false }) => {
