const startFunc = async () => {
    try {
        const spec = await fetch("/samples/row/v9/spec.json").then(res => res.json());
        ...
        console.log("[v23] Live DOM rendered.");
        console.log("[v23] Static HTML String generated:\n", htmlString);
        console.log("[v23] Validation reports:", validationReports);
        console.log("[v23] Invalid spec test:", invalidResult);
    } catch (err) {
        console.error("Failed to render v23 sample:", err);
    }
};
