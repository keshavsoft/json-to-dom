...
import buildSpecElement, { tree } from "../src/v14/index.js";
import validateTag from "../src/v14/jsonToDom/validate/validateTag.js";
import { domToSpec, getStartSpec } from "../src/v14/Reverse/index.js";
...
describe("v14 Separated jsonToDom + Reverse utilities", () => {
    test("root api exposes separate jsonToDom and reverse namespaces", () => {
        assert.ok(tree.jsonToDom);
        assert.ok(tree.reverse);
        assert.equal(typeof tree.jsonToDom.core.buildSpecElement, "function");
        assert.equal(typeof tree.reverse.domToSpec, "function");
    });
    ...
    test("getStartSpec converts src/v14/index.html's #start tree into nested json-to-dom spec", () => {
