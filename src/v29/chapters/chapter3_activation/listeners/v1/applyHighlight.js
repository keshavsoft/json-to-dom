/**
 * applyHighlight - Applies visual highlight to the targeted row
 * Removes any previous highlight from siblings in the container for radio-like feedback.
 */
export const applyHighlight = ({ inTargetElement, inClosestElement, inContainerElement }) => {
    ...
    if (localContainer && typeof localContainer.querySelectorAll === "function") {
        ...
        // Collect all highlight classes configured across buttons in the container
