...
const buildSpecElement = (inArgs) => {
    ...
    if (localValidate && localSpec) {
        ...
        if (!validationResult.isValid) {
            console.warn("[json-to-dom v24: validation error]", validationResult.errors, validationResult);
        } else if (validationResult.warnings && validationResult.warnings.length > 0 && localShowLog) {
            console.warn("[json-to-dom v24: validation warning]", validationResult.warnings);
        }
    }
