//#region src/v3/build/buildSpec/isNullOrUndefined.js
var e = ({ inSpec: e }) => !e, t = ({ inSpec: e }) => e instanceof Node, n = ({ inSpec: e }) => {
...
}, i = ({ inSpec: e }) => e.map((e) => h(e)).flat().filter(Boolean), a = ({ inTagName: e }) => {
	let t = e;
...
}, u = ({ inElement: e, inEvents: t, inTagName: n }) => {
	let r = e, i = t;
	return i && typeof i == "object" && Object.entries(i).forEach(([e, t]) => {
	...
	let t = e;
	return Array.isArray(t) ? t.map((e) => h(e)).flat().filter(Boolean) : [];
}, m = ({ inSpec: e }) => {
	let t = e, n = p({ inChildren: t.children });
	return f({ inSpec: {
		...t,
		children: n
	} });
